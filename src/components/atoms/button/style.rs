...
impl Class for ButtonProps {
    fn base(&self) -> &'static str {
        "text-center font-medium rounded-global-radius disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer select-none"
    }
    ...
    fn variant(&self) -> Option<&'static str> {
        Some(match *self.variant.read() {
            ButtonVariant::Default => match *self.color.read() {
                Color::Default => "bg-foreground text-background hover:bg-foreground/80 active:bg-foreground/70 active:shadow-sm",
                Color::Primary => "bg-primary text-primary-foreground border-primary hover:bg-primary/90 active:bg-primary/80 active:shadow-sm",
                Color::Secondary => "bg-secondary text-secondary-foreground border-secondary hover:bg-secondary/90 active:bg-secondary/80 active:shadow-sm",
                Color::Destructive => "bg-destructive text-destructive-foreground border-destructive hover:bg-destructive/90 active:bg-destructive/80 active:shadow-sm",
                Color::Success => "bg-success text-success-foreground border-success hover:bg-success/90 active:bg-success/80 active:shadow-sm",
                Color::Accent => "bg-accent text-accent-foreground border-accent hover:bg-accent/90 active:bg-accent/80 active:shadow-sm",
                Color::Muted => "bg-muted text-muted-foreground border-muted hover:bg-muted/90 active:bg-muted/80 active:shadow-sm",
            },
            ...
            ButtonVariant::Ghost => match *self.color.read() {
                ...
                Color::Primary => "bg-transparent border-primary text-primary hover:bg-primary/90 hover:text-primary-foreground active:shadow-sm",
                Color::Secondary => "bg-transparent border-secondary text-secondary hover:bg-secondary/90 hover:text-secondary-foreground active:shadow-sm",
                Color::Destructive => "bg-transparent border-destructive text-destructive hover:bg-destructive/90 hover:text-destructive-foreground active:shadow-sm",
                Color::Success => "bg-transparent border-success text-success hover:bg-success/90 hover:text-success-foreground active:shadow-sm",
                Color::Accent => "bg-transparent border-accent text-accent hover:bg-accent/90 hover:text-accent-foreground active:shadow-sm",
                Color::Muted => "bg-transparent border-muted text-muted hover:bg-muted/90 hover:text-muted-foreground active:shadow-sm",
            },
        })
    }
